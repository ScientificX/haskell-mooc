...
oddFactorial 0 = 1
oddFactorial 1 = 1
oddFactorial n = if (oddn n) then (n * oddFactorial (n-1)) else (1 * oddFactorial (n-1))
--
------------------------------------------------------------------------------
...
leftpad str 0 = str
leftpad str n = if (n > length str) then leftpad (" " ++ str) ((n) - length str) else str
------------------------------------------------------------------------------
...
smallestDivisor x = go 1 1
  where go a b = if a == 0 then b else  (go (x `mod` (b+1)) (b+1))
 -----------------------------------------------------------------------------
...
listPrimeLessThan :: Integer -> Integer
listPrimeLessThan x = head $ reverse $ filter isPrime [1..x]
biggestPrimeAtMost :: Integer -> Integer
biggestPrimeAtMost x = listPrimeLessThan x
